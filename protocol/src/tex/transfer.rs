...
macro_rules! define_cell_trs_zhu {
    ( $cid: expr, $class: ident, $zhu_op: ident, $state_op: ident ) => {
        combi_struct! { $class,
            cellid: Uint1
            haczhu: Fold64
        }
...
macro_rules! define_cell_trs_sat {
    ( $cid: expr, $class: ident, $zhu_op: ident, $state_op: ident ) => {
        combi_struct! { $class,
            cellid: Uint1
            satnum: Fold64
...
macro_rules! define_cell_trs_asset {
    ( $cid: expr, $class: ident, $asset_op: ident, $state_op: ident ) => {
        combi_struct! { $class,
            cellid: Uint1
            asset:  AssetAmt
        }
