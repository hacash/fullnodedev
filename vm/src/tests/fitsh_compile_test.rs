// Comprehensive Fitsh Language Compiler Tests
// Tests cover all syntax features and nested expression scenarios.
// NOTE: All comments and messages in this file are in English.
